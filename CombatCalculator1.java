...
/*
Scratched Code:
Spell input for mana on case 2:
if(playerSpell == spellZero){
                                System.out.printf("You interrupt %s!\n\n", monsterName);
                                isInterrupt = true;
                            }
                            
                            if(playerSpell == spellOne){
                                System.out.printf("You polymorph %s!\n\n", monsterName);
                                poly = 2;
                            }
                            
                            if(playerSpell == spellTwo){
                                System.out.printf("You start charging your Frostbolt.\n\n");
                                playerStatus = 2;
                            }
                            
                            if(playerSpell == spellThree){
                                System.out.printf("You start channeling your Heal.\n\n");
                                playerStatus = 3;
                            }
                            
                            if(playerSpell == spellFour){
                                System.out.printf("You instantly use your Fireblast on %s, dealing %d damage! \n\n", monsterName, 60);
                                monsterHealth -= 60;
                            }
                            
                            if(playerSpell == spellFive){
                                System.out.printf("You instantly shoot a burst of lightning at %s, dealing %d damage! \n\n", monsterName, 100);
                                monsterHealth -= 100;
                            }
